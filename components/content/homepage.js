class HomepageElement extends BaseElement {
    constructor() {
        ...
        this.shadowRoot.append(...stringToNodes(`
            ...
            <iframe id="gmap" sandbox="allow-scripts" loading="lazy" allowfullscreen referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed/v1/place?q=457+Parkside+Blvd,+Suite+320,+San+Mateo,+CA+94403&key=AIzaSyCwjOChdJgX2lk92sNjJCoYX6HQseH9sZ8"></iframe>
